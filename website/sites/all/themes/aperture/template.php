...
function aperture_preprocess_page(&$vars) {
  ...
  if (empty($vars['postamble'])) {
    ...
    $vars['postamble'] = '<div style="font-size: 12px; line-height: 20px; text-align: right;"><a href="http://www.prosepoint.net" title="' . $title . '" rel="nofollow"><img src="' . $base_path . drupal_get_path('theme', 'aperture') . '/linkback.png" style="vertical-align: middle;" alt="ProsePoint Express" title="' . $title . '" /></a></div>';
  }
